	...
	<div class="signup">
 		 <div class="form">
		    ...
		    <form:form  name="signUpForm" id="signUpForm" method="post" commandName="iSignUpForm">
		      <form:input type="text" name="username" id="username" path="name" placeholder="full name" value=""></form:input>
		      <form:input type="password" name="password" id="pswd" path="pswd" placeholder="password" value=""></form:input>
		      <form:input type="text" name="email" id="email" placeholder="email address" path="email" value=""></form:input>
		      <form:input type="text" name="mobilenumber" id="mobilenumber" placeholder="mobile number" path="mobilenumber"  value=""></form:input>
		      <form:input type="text" name="enrollmentId" id="enrollmentId" placeholder="Please enter medical enrollment Id" path="enrollmentId"  value=""></form:input>
